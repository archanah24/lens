...
public class ITKillQueryTests extends BaseTestClass {
  ...
  String sleepQuery = QueryInventory.getSleepQuery("7");
...
/*  HadoopUtil.uploadJars(localJarPath + "/" + hiveUdfJar, hdfsJarPath);
    log.info("Adding jar for making query to run for longer period of time");
