...
import org.apache.lens.regression.core.constants.SessionConfig;
...
public class QueryApiTests extends BaseTestClass {
  ...
  private static Logger logger = Logger.getLogger(QueryApiTests.class);
  ...
  */
  ...
  public void passPropertyQueryConf() throws Exception {
    ...
    lensConf.addProperty(SessionConfig.RESULT_SERDE, "org.apache.lens.lib.query.CSVSerde1");
    ...
    lensConf.addProperty(SessionConfig.RESULT_SERDE, "org.apache.lens.lib.query.CSVSerde");
  ...
  public void testExecuteWithTimeout() throws Exception {
    ...
    sHelper.setAndValidateParam(SessionConfig.SERVER_PERSISTENCE, "false");
    sHelper.setAndValidateParam(SessionConfig.DRIVER_PERSISTENCE, "false");
  ...
  public void testGetInMemoryResultSet() throws Exception {
    ...
    sHelper.setAndValidateParam(SessionConfig.SERVER_PERSISTENCE, "false");
    sHelper.setAndValidateParam(SessionConfig.DRIVER_PERSISTENCE, "false");
    sHelper.setAndValidateParam(SessionConfig.ENABLE_MAIL_NOTIFY, "false");
  ...
  public void testGetPersistentResultSet() throws Exception {
    ...
    sHelper.setAndValidateParam(SessionConfig.SERVER_PERSISTENCE, "true");
    sHelper.setAndValidateParam(SessionConfig.DRIVER_PERSISTENCE, "false");
  ...
  void validateInMemoryResultSet(InMemoryQueryResult result) {
...
//    InMemoryQueryResult ResultSetJson = (InMemoryQueryResult) qHelper.getResultSetJson(queryHandle1, "0", "100");
  ...
  public void testQueryResultJsonPersistent() throws Exception {
    ...
    sHelper.setAndValidateParam(SessionConfig.QUERY_RESULT_DIR, parentDir);
...
//    "Persistened result url not matching");
  ...
  public void testDeleteOnInMemoryResult() throws Exception {
    ...
    MapBuilder query = new MapBuilder();
    query.put("sessionid", sessionHandleString);
    query.put("fromindex", "0");
    query.put("fetchsize", "100");
  ...
  /*
      GRILL-1576/LENS-909. When query is formatting result (status between executed and successfull), if fetched for
  ...
  */
  ...
  public void testResultPathBeforeQueryCompletion() throws Exception {
    ...
    sHelper.setAndValidateParam(SessionConfig.DATA_PARTIAL, "false");
    MapBuilder query = new MapBuilder();
    query.put("sessionid", sessionHandleString);
    query.put("fromindex", "0");
    query.put("fetchsize", "100");
