...
public class PreparedQueryTest extends BaseTestClass {
  ...
  static {
    defaultParams.put(SessionConfig.SERVER_PERSISTENCE, "false");
    defaultParams.put(SessionConfig.DRIVER_PERSISTENCE, "false");
  }

  private static Logger logger = Logger.getLogger(PreparedQueryTest.class);
  ...
  public void destroyPreparedQueryByHandle()  throws Exception {
    ...
    query.put("prepareHandle", queryPrepareHandle.toString());
  ...
  public void modifyPreparedQueryByHandle()  throws Exception {
    ...
    lensConf.addProperty(SessionConfig.QUERY_RESULT_DIR, "hdfs://lens-test:8020/tmp/lensreports");
    ...
    Assert.assertEquals(gq.getConf().getProperties().get(SessionConfig.QUERY_RESULT_DIR),
