...
public class RestartTests extends BaseTestClass {
  ...
  private static Logger logger = Logger.getLogger(RestartTests.class);
  ...
  //LENS-924
  @Test(enabled = true)
  public void testsessionConfCorruptOnRestart()  throws Exception {
